...
public class BlueLeftAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action trajectory1 = drive.actionBuilder(new Pose2d(42, 46.5, Math.toRadians(90)))
        ...
        Action trajectory2 = drive.actionBuilder(new Pose2d(55, 62, Math.toRadians(237)))
        ...
        Action trajectory3 = drive.actionBuilder(new Pose2d(56, 44.5, Math.toRadians(87)))
                .strafeTo(new Vector2d(50, 50))
                .waitSeconds(1)
        ...
        // Parks
        Action trajectory4 = drive.actionBuilder(new Pose2d(58, 62, Math.toRadians(247)))
                .strafeTo(new Vector2d(50,50))
                .waitSeconds(1)
        ...
        // Parks
        Action trajectory5 = drive.actionBuilder(new Pose2d(55, 62, Math.toRadians(237)))
                .strafeTo(new Vector2d(50,50))
                .waitSeconds(1)
                .strafeTo(new Vector2d(-64,70))
                .build();
